    ...
    <header>
      <div class="jumbotron jumbotron-fluid bg-grey">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h1 class="text-center display-4">Solicitud de Interpretación</h1>
              <p>&nbsp;</p>
            </div>
          </div>
        </div>
            ...
            <div class="col-12 text-center rounded">    
                <form class="row" method="POST" action="formulariopresupuesto.php" enctype="multipart/form-data" id="presupuesto-form">
                    ...
                    <div class="col-12 bg-light text-center rounded">
                        ...
                        <fieldset class="form-group">
                            <input type="lugar" class="form-control" name="lugar" placeholder="* Lugar" required>
                        </fieldset><br>
                        <fieldset class="form-group">
                            <input type="evento" class="form-control" name="evento" placeholder="* evento" required>
                        </fieldset><br>
                        <fieldset class="form-group">
                            <textarea class="form-control textarea_3rows" name="message" placeholder="* Expliqueme los detalles para este trabajo ej: numero de dias, etc..." ></textarea>
                        </fieldset>
                    </div><br>
